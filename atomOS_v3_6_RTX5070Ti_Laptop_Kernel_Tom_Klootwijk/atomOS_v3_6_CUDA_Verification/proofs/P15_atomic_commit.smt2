...
(declare-const before (_ BitVec 32)) (declare-const proposed (_ BitVec 32)) (declare-const accept Bool)
(assert (and (not accept) (not (= (ite accept proposed before) before))))
(check-sat)
