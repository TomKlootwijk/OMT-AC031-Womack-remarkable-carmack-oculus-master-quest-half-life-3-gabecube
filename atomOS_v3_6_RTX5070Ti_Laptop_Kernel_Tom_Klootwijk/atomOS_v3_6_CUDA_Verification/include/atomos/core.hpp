...
AO_HD inline void invariant_bank(const AngleInput&a,const AngleResult&base,Check*out){
 ...
 // Correctly rounded for binary64 .4; exact enclosure: results/residency_followup/rotation_rounding.json.
 t=a;constexpr double c=0x1.d7954e7dba2f8p-1,s=0x1.8ec3ae92b676bp-2;t.dr=c*a.dr-s*a.dp;t.dp=s*a.dr+c*a.dp;t.alpha=a.alpha+.4;
