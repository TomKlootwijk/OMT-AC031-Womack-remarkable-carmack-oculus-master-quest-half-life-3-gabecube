...
links. The long-term target is general language-model behaviour; the current
distiller learns finite Boolean skills. See `docs/DISTILLED_PROGRAM_BANK.md` for
