#!/usr/bin/env python3
"""Compile the R12 formal document; this does not run the proposed algorithms."""
...
def main():
    ...
    output = ROOT / 'output/pdf/aTOMos_v3_6_1_12_Photonic_Interface_Formalization_Tom_Klootwijk.pdf'
