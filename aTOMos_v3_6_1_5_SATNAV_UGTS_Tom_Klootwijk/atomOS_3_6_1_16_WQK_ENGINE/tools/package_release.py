#!/usr/bin/env python3
"""Package the reviewed R16 PDF after checking retained and imported source bytes."""
...
def main():
    ...
    if (not review.get('extractable_text_all_pages') or not review.get('required_headings_present')
        ...
        raise ValueError('R16 structural/glyph/layout review is incomplete or contains defects')
    ...
    excluded = {'.build', 'LOCAL_APPDATA_FONTCONFIG_CACHE', '__pycache__', 'renders', 'distribution', 'build'}
