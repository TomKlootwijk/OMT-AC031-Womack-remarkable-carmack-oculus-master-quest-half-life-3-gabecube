...
energy at their interfaces. This chapter adopts established momentum and thermodynamic
balances, then restates the finite energy-port contract introduced in R13 for the
...
The XOP frame annotations preserve coordinate identity. Their physical
...
No opcode is needed for these laws. The unified profile binds energy and entropy functions,
