...
State64 comprises sixteen raw 32-bit words. The signed coordinate/rate
fields are $(\rho,\theta,t,\phi,v_\rho,v_\theta,v_t,v_\phi)$, followed
by unsigned orientation, sheet, branch, cell, lineage, and output;
