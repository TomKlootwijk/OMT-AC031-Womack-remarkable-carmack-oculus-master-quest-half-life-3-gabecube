...
root=workspace/'atomOS_3_6_1_8_LIVE'
pdf=root/'output/pdf/aTOMos_v3_6_1_8_Live_GPS_Receiver_Kernel_UGTS_Tom_Klootwijk.pdf'
folder=workspace/'tmp/pdfs/live_final'
...
whole='\n'.join(texts)
for expected in ['3.6.1.8','LIVE-GPS','96,880','6,284','172','175','Klobuchar','Saastamoinen','circle-plus','eigenmatrix']:
