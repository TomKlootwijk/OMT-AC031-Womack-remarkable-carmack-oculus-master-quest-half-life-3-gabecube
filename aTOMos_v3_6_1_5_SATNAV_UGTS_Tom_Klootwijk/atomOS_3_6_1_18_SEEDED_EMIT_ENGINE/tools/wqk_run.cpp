...
const char* usage =
    ...
    "N is a positive decimal uint32. Identical lanes use entry_state().\n"
    "copy32: old q low/high32 -> rho/vrho before each VM instruction; fresh\n"
    "EMIT payload -> copy-drive ASA/NA+JK (valid mask 0xffffffff, q initially 0).\n"
    "Fused chunks contain 1..256 steps with no intermediate observer.\n"
...
int main(int argc, char** argv) {
    ...
    try {
        ...
        out << "{\n  \"profile\": \"ATOMOS-WQK-NATIVE-RUN-R3\",\n"
