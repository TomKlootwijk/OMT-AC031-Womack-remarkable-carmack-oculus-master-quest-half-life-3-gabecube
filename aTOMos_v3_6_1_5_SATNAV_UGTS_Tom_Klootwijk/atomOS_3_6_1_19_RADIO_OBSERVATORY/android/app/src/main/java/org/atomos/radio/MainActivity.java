...
public final class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle saved){
        ...
        TextView eyebrow=text("aTOMos  /  RADIO OBSERVATORY",12,ACCENT,true);page.addView(eyebrow);
        ...
        margin(page,text("3.6.1.19 · Tom Klootwijk\nNo account. No automatic upload. Exports contain the observed SSIDs, BSSIDs and cell identifiers.",12,MUTED,false),18,0);
    ...
    private void loadSessions(){
        ...
        for(int i=0;i<sessions.size();i++){File f=sessions.get(i);names.add(f.getName().substring(0,16)+" · "+f.getName().substring(17,25));if(f.getName().equals(selected))selectedIndex=i;}
