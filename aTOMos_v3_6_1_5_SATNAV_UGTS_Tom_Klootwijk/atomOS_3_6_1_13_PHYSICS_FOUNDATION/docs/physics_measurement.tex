...
Only four SI defining constants are needed by the present optical, electrical
...
the R11 grammar. For example, the numerical coefficient of $h$ is
...
included in $p$ are not counted again in $b_i$. The R11 exact expression can
