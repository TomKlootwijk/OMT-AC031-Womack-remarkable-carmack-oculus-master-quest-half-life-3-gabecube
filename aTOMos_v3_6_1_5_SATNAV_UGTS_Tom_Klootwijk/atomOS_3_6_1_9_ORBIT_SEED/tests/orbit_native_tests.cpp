...
int main(){try{words();dynamics();chebyshev();r2_dynamics();std::cout<<"orbit native: 4000 two-stage recurrences; R1 Kepler, harmonic-potential, frame and polynomial; R2 degree12 spherical oracle, pole continuity, sparse basis, Schwarzschild and forecast EOP checks passed\n";return 0;}catch(const std::exception& e){std::cerr<<e.what()<<'\n';return 1;}}
