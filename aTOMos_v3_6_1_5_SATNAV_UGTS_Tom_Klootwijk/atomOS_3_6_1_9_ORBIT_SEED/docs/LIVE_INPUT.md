...
```powershell
python tools/live_satnav.py --binary bin/cpu/satnav_stream.exe --rtcm source/live_data/centipede_lienss_20260914/capture.rtcm3 --reference-gpst 1473457283 --iono-nav source/live_data/BRDC00WRD_R_20262570000_01D_MN.rnx --out results/my_recorded_run
python tools/live_satnav.py --binary bin/cpu/satnav_stream.exe --rinex-obs source/live_data/07590920.05o --nav source/live_data/07590920.05n --out results/my_rinex_run
```

Use bin/cuda/satnav_stream.exe with --backend cuda for the GPU worker.
