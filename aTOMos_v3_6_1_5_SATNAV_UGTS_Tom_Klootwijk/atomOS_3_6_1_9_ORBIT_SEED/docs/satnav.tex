...
\hypersetup{colorlinks=true,linkcolor=ink,urlcolor=accent,citecolor=accent,
 pdftitle={aTOMos v3.6.1.9 - Orbital Seeds, Timestamp Queries and Literal Kernel},pdfauthor={Tom Klootwijk},
 pdfsubject={Compact orbital seeds; two ASA/NA sets; synchronous JK; ground-station horizons and held-out forecast accuracy},
 pdfkeywords={aTOMos,atomOS,3.6.1.9,UGTS,SCLP,RTCM,NTRIP,GNSS,CUDA,Tom Klootwijk}}
\pagestyle{fancy}\fancyhf{}
\fancyhead[L]{\sffamily\small\textcolor{ink}{aTOMos / v3.6.1.9}}
