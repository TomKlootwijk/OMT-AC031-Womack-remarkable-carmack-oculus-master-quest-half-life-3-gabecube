...
def main():
    ...
    payload["README.md"] = b"""# aTOMos 3.6.1.9 orbital replay runtime
...
complete 3.6.1.9 archive and PDF. The accuracy summaries retain model identities;
...
"""
    ...
    prefix = "aTOMos_3_6_1_9_Orbit_Runtime/"
