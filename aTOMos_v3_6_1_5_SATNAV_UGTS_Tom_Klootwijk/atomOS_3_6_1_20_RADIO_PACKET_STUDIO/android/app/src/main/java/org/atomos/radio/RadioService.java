...
public final class RadioService extends Service {
    ...
    private void startRecording() {
        try {
            ...
            append("session",null,Json.object("app","aTOMos Radio","app_version","3.6.1.20","device_manufacturer",Build.MANUFACTURER,"device_model",Build.MODEL,"android_release",Build.VERSION.RELEASE,"android_sdk",Build.VERSION.SDK_INT,
