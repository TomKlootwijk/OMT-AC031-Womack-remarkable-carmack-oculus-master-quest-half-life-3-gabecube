#!/usr/bin/env python3
"""Compile the R14 formal document; this does not run the proposed algorithms."""
...
def main():
    ...
    output = ROOT / 'output/pdf/aTOMos_v3_6_1_14_Unified_Field_Formalization_Tom_Klootwijk.pdf'
