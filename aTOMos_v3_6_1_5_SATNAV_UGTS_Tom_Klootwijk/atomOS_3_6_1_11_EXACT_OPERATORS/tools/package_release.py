...
PARENT = ROOT.parent / 'atomOS_3_6_1_10_ORBIT_SEED'
MANIFEST = ROOT / 'source/release_manifest.json'
ARCHIVE = ROOT / 'output/distribution/aTOMos_v3_6_1_11_Exact_Operators_Formalization_Tom_Klootwijk.zip'
